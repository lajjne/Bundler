...
namespace Bundler.Configuration {
    ...
    /// </summary>
    public class BundlerProcessingSection : ConfigurationSection {
        /// <summary>
        ...
        public static BundlerProcessingSection GetConfiguration() {
            BundlerProcessingSection clientResourcesProcessingSection = ConfigurationManager.GetSection("cruncher/processing") as BundlerProcessingSection;

            if (clientResourcesProcessingSection != null) {
                return clientResourcesProcessingSection;
            }

            return new BundlerProcessingSection();
        }
        ...
        public class PhysicalFilesElement : ConfigurationElement {
            ...
            [ConfigurationProperty("path", DefaultValue = "~/bundles", IsRequired = true)]
            [StringValidator(MinLength = 3, MaxLength = 200)]
            public string Path {
                get {
